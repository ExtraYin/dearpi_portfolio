...
/***/ function(module, exports, __webpack_require__) {
	...
	var cookie = __webpack_require__(160);
	var TopNavBar = __webpack_require__(159);
	...
	var PortfolioItem = React.createClass({
		...
		showDetailPage: function showDetailPage() {
			...
			ReactDOM.render(React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'container divundernev' },
					React.createElement('embed', {
						src: this.props.project['project_detail_page'],
						alt: this.props.project['project_title'],
						style: thisStyle
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'a',
							{ className: 'project_link', onClick: this.showDetailPage },
				...
				React.createElement(
					'p',
					null,
					this.props.project['project_detail']
				)
			);
		}
	});
	...
	var PortfolioRow = React.createClass({
		displayName: 'PortfolioRow',
	
		render: function render() {
			var item_row = [];
			for (var i = 0; i < this.props.projects.length; i++) {
				item_row.push(React.createElement(PortfolioItem, { project: this.props.projects[i] }));
			}
			return React.createElement(
				'div',
				{ className: 'row' },
	...
	var PortfolioDisplay = React.createClass({
		displayName: 'PortfolioDisplay',
	
		render: function render() {
			var each_row = [];
			for (var i = 0; i < this.props.projects.length / 3; i++) {
				each_row.push(React.createElement(PortfolioRow, { projects: this.props.projects.slice(i * 3, (i + 1) * 3) }));
			}
			return React.createElement(
				'div',
				{ className: 'container' },
	...
	var PortfolioWrapper = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'div',
				null,
				React.createElement(TopNavBar, { changeLang: this.changeLang }),
				React.createElement(
					'div',
					{ className: 'divundernev' },
					React.createElement(PortfolioDisplay, { projects: this.state.projects })
				)
			);
		}
	});
	
	ReactDOM.render(React.createElement(PortfolioWrapper, null), document.getElementById('PortfolioWrapper'));
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                "a",
	                                { className: "nav-opt", href: "index.html" },
	                                this.state.home
	                            )
	                        ),
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                "a",
	                                { className: "nav-opt", href: "portfolio.html" },
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                "a",
	                                { className: "nav-opt", href: "resume.html" },
	                                this.state.resume
	                            )
	                        )
	                    ),
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                "a",
	                                { className: "nav-opt", onClick: this.changeToChinese },
	                                "中文"
	                            )
	                        ),
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                "a",
	                                { className: "nav-opt-eng", onClick: this.changeToEnglish },
	                                "English"
	                            )
	                        ),
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                "a",
	                                { className: "nav-opt", onClick: this.changeToJapanese },
	                                "日本語"
	                            )
	                        )
	                    )
...
/***/ }
/******/ ]);
//# sourceMappingURL=portfolio-browser-bundle.js.map